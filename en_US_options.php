...
$boposts_default_options['body'] =
'<td valign="top" width="130" padding="5">
<table><tr style="word-break:break-all" ><a href="{link}"><img src="{image}" width="110"/></a></tr>
<td width="110"><tr ><p><strong><a href="{link}">{title}</a></strong><br />{excerpt}</p></tr>
</td></table></td>';
